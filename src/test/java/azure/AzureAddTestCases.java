...
//        response2.prettyPrint();
        ...
        String endOfUrl = "https://dev.azure.com/RoofStacks/RoofXR/_testPlans/define?planId=" + planId + "&suiteId=" + suiteId;
    ...
    public static void main(String[] args) throws IOException {
        String organizationUrl = "https://dev.azure.com/RoofStacks";
        String planId = "88382";
